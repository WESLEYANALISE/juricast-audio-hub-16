  ...
  useEffect(() => {
    ...
    const generateWaveform = () => {
      ...
      const baseValues = [
        ...
        0.5, 0.4, 0.5, 0.6, 0.7, 0.8, 0.7, 0.6, 0.5, 0.4,
        0.3, 0.4, 0.5, 0.6, 0.5, 0.4, 0.5, 0.6, 0.7, 0.6,
        0.5, 0.4, 0.3, 0.4, 0.5, 0.4, 0.3, 0.2, 0.3, 0.4
      ];
    ...
    >
      <div className="relative z-10">
        <div className="flex flex-col md:flex-row md:items-center gap-6 mb-4">
          <motion.div 
            className="relative w-full max-w-xs aspect-square mb-4 md:mb-0 overflow-hidden rounded-lg shadow-md mx-auto md:mx-0" 
          ...
          <div className="flex flex-col flex-grow">
            ...
            <div className="flex flex-col gap-4">
              <div 
                className="w-full h-2 bg-juricast-background rounded-full overflow-hidden cursor-pointer" 
              ...
              <div className="flex justify-center md:justify-between items-center gap-4">
                <div className="flex items-center gap-2">
                  <motion.button 
                    ...
                    className="player-button w-8 h-8 md:w-10 md:h-10 flex items-center justify-center rounded-full hover:bg-juricast-background/30"
                ...
                <div className="hidden md:flex gap-2 items-center">
                  <motion.button 
                    ...
                    className="p-2 rounded-full hover:bg-juricast-background/30 text-juricast-muted hover:text-juricast-accent"
                    whileHover={{ scale: 1.1 }}
                    whileTap={{ scale: 0.9 }}
                    title="Download"
                  >
                  ...
                  <div className="relative">
                    ...
                    {showPlaybackOptions && (
                      <div className="absolute bottom-full right-0 mb-2 bg-juricast-card border border-juricast-card/30 rounded-lg p-2 shadow-lg z-20">
